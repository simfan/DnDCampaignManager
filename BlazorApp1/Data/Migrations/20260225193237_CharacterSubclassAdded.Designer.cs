...
namespace BlazorApp1.Migrations
{
    ...
    [Migration("20260225193237_CharacterSubclassAdded")]
    partial class CharacterSubclassAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorApp1.Models.InventoryItem", b =>
                {
            ...
            modelBuilder.Entity("BlazorApp1.Models.AmmunitionItem", b =>
                {
                    b.HasBaseType("BlazorApp1.Models.InventoryItem");

                    b.Property<string>("AmmunitionType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("DamageBonusOverride")
                        .HasColumnType("int");

                    b.HasDiscriminator().HasValue(5);
                });

            modelBuilder.Entity("BlazorApp1.Models.ArmorItem", b =>
                {
                    b.HasBaseType("BlazorApp1.Models.InventoryItem");
            ...
            modelBuilder.Entity("BlazorApp1.Models.MagicItem", b =>
                {
                    b.HasBaseType("BlazorApp1.Models.InventoryItem");
            ...
            modelBuilder.Entity("BlazorApp1.Models.MountItem", b =>
                {
                    b.HasBaseType("BlazorApp1.Models.InventoryItem");

                    b.Property<string>("CarryingCapacity")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MountType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("SpeedFt")
                        .HasColumnType("int");

                    b.HasDiscriminator().HasValue(7);
                });

            modelBuilder.Entity("BlazorApp1.Models.PotionItem", b =>
                {
                    b.HasBaseType("BlazorApp1.Models.InventoryItem");
                    ...
                    b.Property<int?>("HealDiceCount")
                        .HasColumnType("int");

                    b.Property<int?>("HealDiceSides")
                        .HasColumnType("int");

                    b.ToTable("InventoryItems", t =>
                        {
                            t.Property("Effect")
                                .HasColumnName("PotionItem_Effect");
                        });

                    b.HasDiscriminator().HasValue(4);
                });

            modelBuilder.Entity("BlazorApp1.Models.ToolItem", b =>
                {
                    b.HasBaseType("BlazorApp1.Models.InventoryItem");
            ...
            modelBuilder.Entity("BlazorApp1.Models.WeaponItem", b =>
                {
                    b.HasBaseType("BlazorApp1.Models.InventoryItem");

                    b.Property<int>("AbilityUsed")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RangeLongFt")
                        .HasColumnType("int");

                    b.Property<int?>("RangeNormalFt")
                        .HasColumnType("int");

                    b.Property<int>("ReachFt")
                        .HasColumnType("int");

                    b.Property<int?>("VersatileDiceCount")
                        .HasColumnType("int");

                    b.Property<int?>("VersatileDiceSides")
                        .HasColumnType("int");
